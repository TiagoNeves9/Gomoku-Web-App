...
function Cell(props) {
    ...
    if (props.cellType == "BLACK_PIECE")
        return (<button disabled className="cell black-stone"></button>)
    else if (props.cellType == "WHITE_PIECE")
        return (<button disabled className="cell white-stone"></button>)
    else if (turn)
        return (<button onClick={onCellClick} className="cell "></button>)
    else
        return (<button disabled className="cell "></button>)
}
